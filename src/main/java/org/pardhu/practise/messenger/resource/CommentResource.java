...
import org.pardhu.practise.messenger.service.CommentService;
...
public class CommentResource {
	...
	/*
	 * @GET public String getComments() { return "Test Sub resource"; }
	 * 
	 * @GET
	 * 
	 * @Path("/{commentId}") public String getComment(@PathParam("commentId")
	 * long commentID, @PathParam("messageId") long messageId) { return
	 * "Test Sub resource commentId :" + commentID + " messageId = " +
	 * messageId; }
	 */
